...
public class TeacherAttendanceSummaryCenterPanel {
    ...
    public static Pane createPanel() {
        ...
        // Shadow image
        String shadowPath = TeacherAttendanceSummaryCenterPanel.class.getResource("/resources/SHADOW.png").toExternalForm();
        ...
        Text createUsersTitle = new Text("Attendance Summary");
